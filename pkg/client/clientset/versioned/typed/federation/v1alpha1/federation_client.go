...
// FederationV1alpha1Client is used to interact with features provided by the federation.volcano.sh group.
type FederationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FederationV1alpha1Client) ClusterInfos() ClusterInfoInterface {
